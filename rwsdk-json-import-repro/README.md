...
This is the case discussed in the rwsdk Discord (June 2026), worked around in a
real-world app with a custom `jsonModulePlugin`.
...
This is the same plugin a real-world app has carried for over six months
(original gist:
